...
$$
This modeling is used in Safe Reinforcement Learning, where you define the cost function as a separated signal. This is the most basic type of modelling for Safe RL but there are others.